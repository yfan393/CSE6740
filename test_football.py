...
# New URL: https://www.cbssports.com/collegefootball/schedule
#
...
#
# --------------------------------------------------------------------------
# The codes are based on Python2.7. (updated to Python3) 
# Please install numpy, scipy, matplotlib packages before using.
# Thank you for your suggestions!
#
# @version 1.0
# @author CSE6740/CS7641 TA (updated by Kai Wang for CSE/ISyE 6740)
#########################################################################
import numpy as np
...
with open(un_edge_file, 'w') as fid:
...
with open(un_node_file, 'w') as fid:
    writer = csv.writer(fid)
